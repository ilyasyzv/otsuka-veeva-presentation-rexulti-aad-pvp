...
com.veeva.clm = {
  ...
  getProduct_OrderActive_Account: function (accountOrAccountGroup, callback) {
    ...
    window["com_veeva_clm_ordersWithListPrice"] = function (result) {
      ...
      if (result.success) {
        orderIds = [];
        if (
          result.Pricing_Rule_vod__c &&
          result.Pricing_Rule_vod__c.length > 0
        ) {
        ...
        com.veeva.clm.wrapResult(
          "getProduct_OrderActive_Account",
          callback,
          ret
        );
      } else {
  ...
  getListPrice_Product: function (product, callback) {
    ...
    // 2
    window["com_veeva_clm_listPriceTypeId_getListPrice_Product"] = function (
      result
    ) {
      result = com.veeva.clm.formatResult(result);
      if (result.success && result.RecordType && result.RecordType.length > 0) {
        ...
        if (!com.veeva.clm.testMode) com.veeva.clm.runAPIRequest(query);
          ...
          com_veeva_clm_productPricingRules(
            com.veeva.clm.testResult.listPrices
          );
      } else {
        com.veeva.clm.wrapResult("getListPrice_Product", callback, result);
      }
    ...
    if (!com.veeva.clm.testMode) com.veeva.clm.runAPIRequest(recordTypeQuery);
      ...
      com_veeva_clm_listPriceTypeId_getListPrice_Product(
        testResult.listPriceRecordType
      );
  },
  ...
  getListPrice_Product_Account: function (product, account, callback) {
    ...
    window["com_veeva_clm_get_productDefaultPricingRules"] = function () {
      ...
      if (!com.veeva.clm.testMode) com.veeva.clm.runAPIRequest(groupQuery);
        ...
        // TODO
        com_veeva_clm_productDefaultPricingRules(
          com.veeva.clm.testResult.listPrices
        );
      }
    };

    window["com_veeva_clm_productAccountGroupPricingRules"] = function (
      result
    ) {
      result = com.veeva.clm.formatResult(result);
      ...
      if (result.success) {
        ...
        if (accountGroup != undefined && accountGroup != "") {
          ...
          if (!com.veeva.clm.testMode) com.veeva.clm.runAPIRequest(groupQuery);
            ...
            // TODO
            com_veeva_clm_productAccountGroupPricingRules(
              com.veeva.clm.testResult.listPrices
            );
          }
        } else {
      ...
      function (result) {
        ...
        if (
          ...
          if (!com.veeva.clm.testMode) com.veeva.clm.runAPIRequest(query);
            ...
            com_veeva_clm_productAccountPricingRules(
              com.veeva.clm.testResult.listPrices
            );
        } else {
          com.veeva.clm.wrapResult(
    ...
    if (!com.veeva.clm.testMode) com.veeva.clm.runAPIRequest(recordTypeQuery);
      ...
      com_veeva_clm_listPriceTypeId_getListPrice_Product_Account(
        testResult.listPriceRecordType
      );
  },
                ...
                for (var j = 0; j < productGroups.length; j++) {
                  ...
                  if (
                    ...
                    detailGroupProducts[i].ID ==
                      productGroups[j].Product_Catalog_vod__c &&
                ...
                if (
                  ...
                  if (
                    ...
                    for (var i = 0; i < productsWithDetailGroups.length; i++) {
                      if (
                        result.Approved_Document_vod__c[0]
                          .Detail_Group_vod__c != undefined &&
                        result.Approved_Document_vod__c[0].Product_vod__c ==
                        ...
                        var ret = {};
                        ret.Approved_Document_vod__c = {};
                        ret.Approved_Document_vod__c.ID =
                          result.Approved_Document_vod__c[0].ID;
                        ret.success = true;
                        com.veeva.clm.wrapResult(
                          "getApprovedDocument",
                          callback,
            ...
            if (result.code == 1021) {
              if (result.message.indexOf("Detail_Group_vod__c") >= 0) {
                ...
                if (!com.veeva.clm.testMode)
                  ...
                  com_veeva_clm_DocumentTypeId_getDocument(
                    testResult.approvedDocumentWithId2
                  );
              }
              return;
            }
        ...
        window["com_veeva_clm_getProductGroups"] = function (result) {
          ...
          if (result.success) {
            ...
            if (!com.veeva.clm.testMode)
              ...
              com_veeva_clm_DocumentTypeId_getDocument(
                testResult.approvedDocumentWithId
              );
          } else {
            if (result.code == 1011) {
          ...
          if (result.success) {
            ...
            com.veeva.clm.getProduct_MySetup("Detail", function (result) {
              if (result.success) {
                ...
                com.veeva.clm.getProduct_MySetup(
                  "Detail Group",
                  function (result) {
                    if (result.success) {
                      ...
                      var groupArray =
                        com.veeva.clm.joinStringArrayForIn(detailGroupIDs);
                      if (groupArray == "") {
                        groupArray = "{}";
                      }
                      ...
                      if (!com.veeva.clm.testMode)
                        ...
                        com_veeva_clm_getProductGroups(
                          com.veeva.clm.testResult.productGroups
                        );
                    } else {
  ...
  launchApprovedEmail: function (email_template, email_fragments, callback) {
    ...
    if (!com.veeva.clm.testMode) com.veeva.clm.runAPIRequest(request);
      ...
      com_veeva_clm_launchApprovedEmail(
        com.veeva.clm.testResult.approvedEmailId
      );
  },
  ...
  createRecord: function (object, values, callback) {
    ...
    request = com.veeva.clm.generateSaveRecordRequest(
      object,
      values,
      "com_veeva_clm_createRecord"
    );
  ...
  gotoSlide: function (keyMessage, presentation) {
    console.log("CLM: Step 1 :Checking Argument", keyMessage, presentation);
    ret = this.checkArgument("keyMessage", keyMessage);
    console.log("CLM: Step 2 : click to " + JSON.stringify(ret));
    if (ret.success == false) {
      return ret;
    }
    console.log("CLM: Next stage");
    request = null;
    if (
  ...
  nextSlide: function () {
    console.log("Veeva Inner: Next Slide");
  ...
  prevSlide: function () {
    console.log("Veeva Inner: Previous Slide");
  ...
  formatCreateRecords: function (objectArray, valueArray) {
    ...
    for (var ndx = 0; ndx < objectArray.length; ndx++) {
      fullString = fullString.concat(
        com.veeva.clm.generateSaveRecordRequest(
          objectArray[ndx],
          valueArray[ndx],
          ""
        ) + ";"
  ...
  getRecordTypeLabels: function (object, callback) {
    ...
    request =
      "veeva:getRecordTypeLabels(" +
      object +
      "),com_veeva_clm_getRecordTypeLabelsReturn(result)";
    com.veeva.clm.runAPIRequest(request, callback);
  },
  ...
  request: function (object, callback) {
    ...
    var request =
      ...
      "),com_veeva_clm_requestReturn(result)";
    com.veeva.clm.runAPIRequest(request, callback);
  },
  ...
  launchSelector: function (presentationSlides, callback) {
    ...
    if (presentationSlides.constructor === Array) {
      ...
      for (var i = 0; i < presentationSlides.length; i++) {
        ...
        if (
          presentationMessages != null &&
          typeof presentationMessages === "object"
        ) {
    ...
    if (!com.veeva.clm.testMode) com.veeva.clm.runAPIRequest(request);
      ...
      com_veeva_clm_launchSelector(
        com.veeva.clm.testResult.launchSelectorResult
      );
  },
  ...
  validateRequestObjectWithErrorMessage: function (request) {
    ...
    //optional
      ...
      errorString =
        "Invalid headers value. Must be an object with values of type String";
    }
    //validate timeout
    //must be a number
    //optional
    ...
    //optional
      ...
      errorString =
        "Invalid expect value.  Must be a String of value 'text' or 'blob'";
    } else {
      errorString = "Valid";
    }
  ...
  validateMethod: function (method) {
    return (
      ...
      !!~this.methods.indexOf(method.toUpperCase())
    );
  },
    ...
    if (data.type && data.type === "events") {
      ...
      if (data.event.type === "change") {
        ...
        var target = document.elementFromPoint(
          data.event.location.x,
          data.event.location.y
        );
        if (target) {
...
var com_veeva_clm_createRecordsOnExit = function () {
  return com.veeva.clm.createRecordsOnExit();
};
var com_veeva_clm_updateRecordsOnExit = function () {
  return com.veeva.clm.updateRecordsOnExit();
};
var com_veeva_clm_updateCurrentRecordsOnExit = function () {
  return com.veeva.clm.updateCurrentRecordsOnExit();
};

console.log("Veeva CLM : initialize");
