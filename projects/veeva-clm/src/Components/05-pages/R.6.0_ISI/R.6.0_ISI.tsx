        ...
        >
          ...
          <Paragraph>
            <strong>
              ...
              established in pediatric patients with MDD.
            </strong>
          </Paragraph>
          <Paragraph>
          ...
          <Paragraph>
            ...
            In clinical trials, elderly patients with dementia randomized to
          ...
          <Paragraph>
            ...
            signs of NMS are hyperpyrexia, muscle rigidity, altered mental
            ...
            discontinuation of REXULTI, intensive symptomatic treatment, and
            monitoring.
          </Paragraph>
          <Paragraph>
            ...
            drugs. TD can develop after a relatively brief treatment period,
            even at low doses, or after discontinuation of treatment. For
            chronic treatment, use the lowest dose and shortest duration of
            REXULTI needed to produce a clinical response. If signs and symptoms
            of TD appear, drug discontinuation should be considered.
          </Paragraph>
          <Paragraph>
            <strong>Metabolic Changes:</strong> Atypical antipsychotic drugs
            ...
            content={{
              ...
              data: [
                ...
                },
                {
                  text: (
                    <span>
                      <strong>Dyslipidemia:</strong> Atypical antipsychotics
                      cause adverse alterations in lipids. Before or soon after
                ...
                },
                {
                  text: (
                    <span>
                      <strong>Weight Gain:</strong> Weight gain has been
                      observed in patients treated with REXULTI. Monitor weight
          ...
          <Paragraph>
            ...
            the risk is greatest during initial dose titration and when
            increasing the dose. Monitor in patients vulnerable to hypotension,
            and those with cardiovascular and cerebrovascular diseases.
          </Paragraph>
          <Paragraph>
            <strong>Falls:</strong> Antipsychotics may cause somnolence,
            postural hypotension, motor and sensory instability, which may lead
            to falls causing fractures or other injuries. For patients with
            diseases, conditions, or medications that could exacerbate these
            effects, complete fall risk assessments when initiating treatment
          ...
          <Paragraph>
            <strong>Dysphagia:</strong> Esophageal dysmotility and aspiration
            have been associated with antipsychotics, including REXULTI, and
            should be used with caution in patients at risk for aspiration.
          </Paragraph>
          <Paragraph>
            <strong>Potential for Cognitive and Motor Impairment:</strong>{' '}
            REXULTI has the potential to impair judgment, thinking, or motor
            skills. Patients should not drive or operate hazardous machinery
            until they are reasonably certain REXULTI does not affect them
            adversely.
          </Paragraph>
          <Paragraph>
          ...
          <Paragraph>
            <strong>Most commonly observed adverse reactions:</strong> In
              ...
              data: [
                {
                  text: (
                    <span>
                      ...
                      (adjunctive treatment to antidepressant therapy; 25%
                      incidence and at least twice the rate of placebo for
                      REXULTI vs. placebo): akathisia and weight increased
                    </span>
                  ),
                },
                {
          ...
          <Paragraph>
            ...
            susceptible individuals during the first days of treatment and at
            low doses.
          </Paragraph>
          <Paragraph>
            <strong>Pregnancy:</strong> Adequate and well-controlled studies to
            assess the risks of REXULTI during pregnancy have not been
            conducted. REXULTI should be used during pregnancy only if the
            benefit justifies the risk to the fetus.
          </Paragraph>
          <Paragraph>
            <strong>Lactation:</strong> It is not known if REXULTI is excreted
            in human breast milk. A decision should be made whether to
